    ...
    <div class="dropdown mt-3">
            <button type="button"  style="width: 200px; margin-left: 80px;" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"><b>Summer Youth Games<b></button>
    ...
    <div class="container">
      ...
      <h3 class="subtitle" style="font-size: 100px;"><b>A</b></h3>
         <p class="description">
            <ul>
              <a class="link" href="https://olympics.com/en/sports/acrobatic-gymnastics/" style="color: black;"><li>Acrobatic Gymnastic<br></li></a>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/archery" style="color: black;"><li>Archery<br></li></a>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/artistic-gymnastics" style="color: black;"><li>Artistic Gymnastics</li></a>
             <a class="link" href="https://olympics.com/en/paris-2024/sports/athletics" style="color: black;"><li>Athletics</li></a>
           </ul>
       </p>
           </div>

           <div class="col-md-3 col-sm-3 col-lg-3">
      <h3 class="subtitle" style="font-size: 100px;"><b>B</b></h3>
         <p class="description">
            <ul>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/badminton" style="color: black;"><li>Badminton<br></li></a>
              <a class="link" href="https://olympics.com/en/sports/baseball-5/" style="color: black;"><li>Baseball 5<br></li></a>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/boxing" style="color: black;"><li>Boxing</li></a>
             <a class="link" href="https://olympics.com/en/paris-2024/sports/3x3-basketball" style="color: black;"><li>Basketball 3x3</li></a>
           </ul>
       </p>
           </div>

           <div class="col-md-3 col-sm-3 col-lg-3">
      <h3 class="subtitle" style="font-size: 100px;"><b>C</b></h3>
         <p class="description">
            <ul>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/cycling-road" style="color: black;"><li>Cycling Road<br></li></a>
             <a class="link" href="https://olympics.com/en/paris-2024/sports/cycling-bmx-racing" style="color: black;"><li>Cycling BMX Racing</li></a>
           </ul>
       </p>
           </div>
            <div class="col-md-3 col-sm-3 col-lg-3">
        <h3 class="subtitle" style="font-size: 100px;"><b>F</b></h3>
         <p class="description">
            <ul>
              <a class="link" href="https://olympics.com/en/paris-2024/sports/fencing" style="color: black;"><li>Fencing<br></li></a> 
              <a class="link" href="https://olympics.com/en/sports/futsal/" style="color: black;"><li>Futsal<br></li></a> 
            </ul>
              </p>
              </div> 
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-lg-4">
                <video class="vid" src="public\images\video.htm" controls class="video"></video>
                <ul>
